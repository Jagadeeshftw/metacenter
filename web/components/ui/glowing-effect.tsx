          ...
          style={
            {
              ...
              "--gradient":
                variant === "white"
                  ...
                  : `radial-gradient(circle, #26a596 10%, #26a59600 20%),
                radial-gradient(circle at 40% 40%, #bd8420 5%, #bd842000 15%),
                radial-gradient(circle at 60% 60%, #5b8def 10%, #5b8def00 20%), 
                radial-gradient(circle at 40% 60%, #8e7deb 10%, #8e7deb00 20%),
                repeating-conic-gradient(
                  from 236.84deg at 50% 50%,
                  #26a596 0%,
                  #bd8420 calc(25% / var(--repeating-conic-gradient-times)),
                  #5b8def calc(50% / var(--repeating-conic-gradient-times)), 
                  #8e7deb calc(75% / var(--repeating-conic-gradient-times)),
                  #26a596 calc(100% / var(--repeating-conic-gradient-times))
                )`,
