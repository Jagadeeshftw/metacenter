...
Reserve: 152,669,889 sats [onchain] — hypothetical cover 5.52 cycles; a back-stop by design, accrual-only in this iteration (using it goes through a SIP process)
