...
|---|---|---|
| `MIN_COVERAGE_BPS` | `u20000`, 2.0× | The level discussed in the [Bitcoin Staking SIP thread](https://forum.stacks.org/t/introducing-the-bitcoin-staking-sip-v1-draft/18862/14) (friedger, post #14); the SIP draft sets no coverage target. Equivalent to 50% headroom. Coverage is <Metric name="coverage" />, so a vault using this threshold is not paused today. |
