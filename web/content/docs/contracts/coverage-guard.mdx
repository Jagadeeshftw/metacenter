...
This one is on testnet, reading the publisher-posted `risk-feed`. The mainnet example, reading pox5-reader's own figures through `coverage-cache`, is [coverage-guard-cached](/docs/contracts/coverage-guard-cached).
